...
export default function VaccinationsChart1() {
    ...
    const chart=()=> {
        ...
        axios.get("https://raw.githubusercontent.com/VinceTruong/Visual_Analysis_Project/main/Data/Vaccinations%20per%20day/Vaccinations%20per%20day1.json")
        .then(res =>{
